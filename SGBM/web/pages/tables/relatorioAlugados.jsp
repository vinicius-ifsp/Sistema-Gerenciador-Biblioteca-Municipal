 ...
 <aside class="main-sidebar">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Livros Alugados
        <small>Relatório de Livros Alugados</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../../inicio.jsp"><i class="fa fa-dashboard"></i> Início</a></li>
        <li><a href="relatorioAlugados.jsp">Tabela</a></li>
        <li class="active">Livros Alugados</li>
      </ol>
    </section>
                ...
                <label for="relatorio">Relatório: </label>
                  <div class="input-group">
                    ...
                    <select class="form-control">
                      ...
                      <option value="4">Livros Mais Alugados</option>
                    </select>
                  </div>
                </div>
            </div>
