            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="../../inicio.jsp" class="btn btn-default btn-flat">Sair</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="cadastrarCliente.jsp"><i class="fa fa-circle-o"></i> Clientes</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="clientes.jsp">Cadastrar</a></li>
 ...
 <section class="content">
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 style="font-size: 40px" class="box-title">Cadastrar Cliente</h3>
      </div>
      <!-- form start -->
      <form action="../../CadastrarLeitor" method="post" data-toggle="validator" role="form" id="cadastrarCliente">
        <div class="box-body">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="endereco" class="form-control" id="endereco" placeholder="Endereço Completo" data-error="Por favor, preencha corretamente." required pattern="[a-z A-Z á-ú Á-ú-]*">
                      </div>
                      <div class="help-block with-errors"></div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label for="email">E-Mail</label>
                      <div class="input-group">
                        ...
                        <input type="text" name="email" class="form-control" id="email" placeholder="exemplo@exemplo.com" data-error="Por favor, informe um e-mail válido" required pattern="[a-z A-Z á-ú Á-ú-@.]*">
                      </div>
                      <div class="help-block with-errors"></div>
                    </div>
                </div>
