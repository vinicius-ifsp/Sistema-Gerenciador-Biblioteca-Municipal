 ...
 <aside class="main-sidebar">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Livros
        <small>Relatório de Livros</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../../inicio.jsp"><i class="fa fa-dashboard"></i> Início</a></li>
        <li><a href="relatorioLivro.jsp">Tabela</a></li>
                ...
                <label for="relatorio">Relatório: </label>
                  <div class="input-group">
                    ...
                    <select class="form-control">
                      <option value="1">Todos os Livros</option>
                      <option value="2">Ultimos Livros Cadastrados</option>
                    </select>
                  </div>
                </div>
            </div>
