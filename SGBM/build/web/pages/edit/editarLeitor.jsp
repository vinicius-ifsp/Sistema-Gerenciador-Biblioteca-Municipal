      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
              <li><a href="../forms/cadastrarEmprestimo.jsp"><i class="fa fa-circle-o"></i> Empréstimos</a></li>
              <li><a href="../forms/cadastrarLivro.jsp"><i class="fa fa-circle-o"></i> Livros</a></li>
              <li><a href="../forms/cadastrarLeitor.jsp"><i class="fa fa-circle-o"></i> Leitores</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
              <li><a href="editarEmprestimo.jsp"><i class="fa fa-circle-o"></i> Empréstimos</a></li>
              <li><a href="editarLivro.jsp"><i class="fa fa-circle-o"></i> Livros</a></li>
              <li><a href="editarLeitor.jsp"><i class="fa fa-circle-o"></i> Leitores</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
 ...
 <section class="content">
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 style="font-size: 40px" class="box-title">Buscar Leitor</h3>
      </div>
      <!-- form start -->
      <form action="../../EditarBuscar" method="post" data-toggle="validator" role="form" id="cadastrarCliente">
        <div class="box-body">
            <input type="hidden" value="Leitor" name="tipoEdicaoBusca"> 
            <div class="col-md-12">
